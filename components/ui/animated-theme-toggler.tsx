...
export const AnimatedThemeToggler = ({
  ...
  return (
    ...
    >
      {/*
        `children` wins over the state-driven icons so a caller can swap them
        with CSS (`dark:` variants) instead of React state. That matters when the
        theme is applied by a pre-paint script: state-driven icons render the
        server's guess first and visibly flip on hydration, CSS-driven ones are
