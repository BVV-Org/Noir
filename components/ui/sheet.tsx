...
/**
 * Sheet — the off-canvas drawer primitive (DESIGN_SYSTEM.md §4).
 *
 * Built on Radix Dialog, so focus trapping, scroll locking, `Esc` to dismiss,
 * and the `aria-modal` wiring come for free. Used by the mobile menu here, and
 * later by the cart and the shop's filter panel.
 */
