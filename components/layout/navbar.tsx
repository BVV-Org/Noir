 ...
 *
 * Sticky rather than fixed: it stays in flow, so no page has to reserve a
 * top offset and full-bleed sections keep working. At rest the bar is
 * transparent against the matte black page; once content scrolls beneath it the
            ...
            {mainNav.map((item) => {
              ...
              return (
                <Link
                  ...
                  className={cn(
                    "relative py-2 text-small font-medium transition-colors duration-150 ease-premium",
                    active
                      ? "text-foreground"
                ...
                >
                  ...
                  <span
                    aria-hidden
                    className={cn(
                      "absolute inset-x-0 -bottom-px h-px bg-primary transition-opacity duration-150 ease-premium",
